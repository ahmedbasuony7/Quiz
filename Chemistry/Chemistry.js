...
let DraftBtn = document.querySelector('.Draft');
...
function getQuestion (){
    ...
    myReqest.onreadystatechange = function(){
        if(this.readyState === 4  && this.status === 200  ){
            ...
            submitButton.onclick = function(){
                ...
                //  pass the type of question
                let answerType = questionObject[currentIndex].type;
                ...
                // check the answer 
                checkAnswer(theRightAnswer,questionscount , answerType);
    ...
    myReqest.open("GET","Easyc.json",true);
    myReqest.send();
}
getQuestion();
...
//  create the 
function checkAnswer(rightAnswerToCompare , qcount , answerType){
...
function showResults(count){
    if(currentIndex === count){
        ...
        }else if(rightAnswer <= 1  && rightAnswer  <= 20  ){
            theResults  = `<span class="good"> Fair  you answer ${rightAnswer} from ${count} </span>`;
        }else if(rightAnswer >= 21  &&  rightAnswer <= 30  ){
            theResults  = `<span class="perfect"> Excellent  you answer ${rightAnswer} from ${count} </span> </span>`;
        }
...
function    Meduim ( ){
    ...
    function getQuestion (){
        ...
        myReqest.open("GET","Meduimc.json",true);
        myReqest.send();
    }
    getQuestion();
    ...
    function    Hard ( ){
        ...
        function getQuestion (){
            ...
            myReqest.open("GET","Hardc.json",true);
            myReqest.send();
        }
        getQuestion();
